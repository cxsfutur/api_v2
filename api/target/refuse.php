...
<div class="logo">
    <a href="https://www.mixao.cn">
        <img src="//static.mixao.cn/static/img/logo_black_trans.png"
             srcset="//static.mixao.cn/static/img/logo_black_trans%402x.png 2x" alt="智识の小站">
    </a>
</div>
<div class="wrapper">
    <div class="content">
        <h1>即将离开智识の小站</h1>
        <p class="info warning">你访问的网站有安全风险，切勿在该网站输入帐号和密码。</p>
    ...
    <div class="actions">
        ...
        <div class="tip">
            你访问的网站包含未知的安全风险，可能诱导你填写帐号密码、密保等信息，甚至存在木马病毒，建议你不要访问。
        </div>
    </div>
</div>
<script>
